...
<main class="main-container">
  <header class="page-header">
    <div class="page-header-bg" data-interchange="[dist/assets/images/apoio/banner-page-1920x100.jpg, small]"></div>
    <div class="grid-container">
      <div class="grid-x grid-padding-x">
        <div class="cell">
          <h1 class="page-header-title">Kitchen Sink</h1>
        </div>
      </div>
    </div>
  </header>
            ...
            <div id="components" class="kitchen-sink-components">
              <article class="content">
                ...
                <form data-abide novalidate>
                  ...
                  <div class="row">
                    ...
                    <div class="medium-6 columns">
                      <label>
                        Date
                        <input class="js-datepicker-trigger" type="text" placeholder="dd/mm/aaaa">
                      </label>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <fieldset class="medium-6 columns">
                      ...
                      <input type="radio" name="pockets" value="Red" id="pocketsRed2"><label for="pocketsRed">Red</label>
                      <input type="radio" name="pockets" value="Blue" id="pocketsBlue2"><label for="pocketsBlue">Blue</label>
                      <input type="radio" name="pockets" value="Yellow" id="pocketsYellow2"><label for="pocketsYellow">Yellow</label>
                    </fieldset>
                    <fieldset class="medium-6 columns">
                ...
                <div class="flex-video">
                  <iframe width="560" height="315" src="https://www.youtube.com/embed/LXPaDL_oILs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
                <hr>
                ...
                <form>
                  ...
                  <div class="row">
                    <fieldset class="large-6 columns">
                      ...
                      <input type="radio" name="pokemon" value="Red" id="pokemonRed7" required><label for="pokemonRed">Red</label>
                      <input type="radio" name="pokemon" value="Blue" id="pokemonBlue7"><label for="pokemonBlue">Blue</label>
                      <input type="radio" name="pokemon" value="Yellow" id="pokemonYellow7"><label for="pokemonYellow">Yellow</label>
                    </fieldset>
                    <fieldset class="large-6 columns">
                      <legend>Check these out</legend>
                      <input id="checkbox11" type="checkbox"><label for="checkbox11">Checkbox 1</label>
                      <input id="checkbox22" type="checkbox"><label for="checkbox22">Checkbox 2</label>
                      <input id="checkbox33" type="checkbox"><label for="checkbox33">Checkbox 3</label>
                    </fieldset>
                  </div>
                  <div class="row">
